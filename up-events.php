...
<head>
    ...
    <link rel="stylesheet" href="up-events.css">
    ...
    <div class="body">
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="events">
                ...
                <div class="images">
                    <div class="events1-1" style="background-image: url('<?php echo $row['image']; ?>');"></div>

                </div>
                <div class="event-details">
                    <h4>Event ID: <?php echo $row['event_ID']; ?></h4><br>
                    <h4>Event Date: <?php echo $row['date']; ?></h4><br>
                    <h4>Event Location: <?php echo $row['location']; ?></h4><br>
                    <p class="Para"><?php echo $row['description']; ?></p>
                </div>
                <form method="post">
                    <button type="submit" name="redirectButton" class="join-button">Join</button>
                </form>
                <?php
